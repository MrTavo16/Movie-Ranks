...
def seed_movies():
    ...
    movie3 =  Movie(movie_id=1072790 ,title='Anyone But You', description="After an amazing first date, Bea and Ben’s fiery attraction turns ice cold — until they find themselves unexpectedly reunited at a destination wedding in Australia. So they do what any two mature adults would do: pretend to be a couple.", poster_path='/yRt7MGBElkLQOYRvLTT1b3B1rcp.jpg')
    ...
    movie5 =  Movie(movie_id=1227816 ,title="Red Right Hand", description="Cash is trying to live a quiet, honest life in a small Appalachian town. When a vicious crime boss forces him back into her services, he soon learns he's capable of anything -- even killing -- to protect his family and his home.", poster_path="/vfEG79SQIg3p6B8rBLVeIo2BBhb.jpg")
    movie6 =  Movie(movie_id=693134 ,title="Dune: Part Two", description="Follow the mythic journey of Paul Atreides as he unites with Chani and the Fremen while on a path of revenge against the conspirators who destroyed his family. Facing a choice between the love of his life and the fate of the known universe, Paul endeavors to prevent a terrible future only he can foresee.", poster_path="/8b8R8l88Qje9dn9OE8PY05Nxl1X.jpg")
    ...
    movie8 =  Movie(movie_id=673593 ,title="Mean Girls", description="New student Cady Heron is welcomed into the top of the social food chain by the elite group of popular girls called ‘The Plastics,’ ruled by the conniving queen bee Regina George and her minions Gretchen and Karen. However, when Cady makes the major misstep of falling for Regina’s ex-boyfriend Aaron Samuels, she finds herself prey in Regina’s crosshairs.", poster_path="/fbbj3viSUDEGT1fFFMNpHP1iUjw.jpg")
    movie9 =  Movie(movie_id=438631 ,title='Dune', description="Paul Atreides, a brilliant and gifted young man born into a great destiny beyond his understanding, must travel to the most dangerous planet in the universe to ensure the future of his family and his people. As malevolent forces explode into conflict over the planet's exclusive supply of the most precious resource in existence-a commodity capable of unlocking humanity's greatest", poster_path="/d5NXSklXo0qyIYkgV94XAgMIckC.jpg")
    movie10 = Movie(movie_id=994108 ,title='All of Us Strangers', description="One night in his near-empty tower block in contemporary London, Adam has a chance encounter with a mysterious neighbor Harry, which punctures the rhythm of his everyday life. As a relationship develops between them, Adam is preoccupied with memories of the past and finds himself drawn back to the suburban town where he grew up", poster_path='/aviJMFZSnnCAsCVyJGaPNx4Ef3i.jpg')
